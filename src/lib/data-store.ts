...
export const SEED_SPRINTS = [
  ...
  {
    id: 'sprint-02-w',
    name: 'Sprint 31 (รายสัปดาห์) - งานระบบสารสนเทศส่วนเลขานุการ',
  ...
  {
    id: 'sprint-04-m',
    name: 'Sprint Q3/August (รายเดือน) - Public Portal Integration',
...
export const SEED_BACKLOGS = [
  ...
  },
  {
    id: 'backlog-03',
    sprintId: 'sprint-01',
    title: 'สอบทานระบบความมั่นคงปลอดภัยข้อมูลตามมาตรฐาน PDPA',
    description: 'ตรวจสอบนโยบายคุ้มครองข้อมูลส่วนบุคคล',
    priority: 'MEDIUM',
  ...
  },
  {
    ...
    title: 'พัฒนาฟังก์ชั่นค้นหาราคาประเมินตามเลขที่โฉนดและระบุพิกัด GIS',
  ...
  },
  {
    id: 'backlog-10',
    sprintId: 'sprint-04-w',
    title: 'จัดทำ PDF Export รายงานหนังสือรับรองราคาประเมิน',
    description: 'ออกหนังสือรับรองราคาประเมินทางการ',
    priority: 'MEDIUM',
    status: 'PLANNED' as const,
    startDate: '2026-08-01',
    endDate: '2026-08-07',
